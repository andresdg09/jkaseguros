...
CREATE TABLE IF NOT EXISTS tarifas (
    ...
    examenes_especiales BOOLEAN DEFAULT FALSE,
    asist_intl BOOLEAN DEFAULT FALSE,
    oftalmologia_suma VARCHAR(50),
    oftalmologia_costo VARCHAR(50),
    odontologia_suma VARCHAR(50),
    odontologia_costo VARCHAR(50),
    consultas_suma VARCHAR(50),
    consultas_costo VARCHAR(50),
    asist_medica_primaria_suma VARCHAR(50),
    asist_medica_primaria_costo VARCHAR(50),
    odonto_oftal_suma VARCHAR(50),
    odonto_oftal_costo VARCHAR(50),
    fisio_psico_suma VARCHAR(50),
    fisio_psico_costo VARCHAR(50),
    dermato_nutricion_suma VARCHAR(50),
    dermato_nutricion_costo VARCHAR(50),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
-- 16. Tabla de Renovaciones de Pólizas
